	...
	;This licence will expire on Tue, 24 Jun 2014
	...
	; Compiler options:
	;
	; -oSchoolBell.cof -mSchoolBell.map --summary=default --output=default \
	; Keypad.p1 LCD.p1 Main.p1 DS1307.p1 I2C.p1 ADC.p1 --chip=16F877 -P \
