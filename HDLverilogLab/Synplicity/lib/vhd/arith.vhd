...
--                                                                         --
------------------------------------------------------------------------------
-- $Header: s:/rcs/vhdl/vhd/RCS/arith.vhd 1.6 1998/10/07 22:13:55 mala Exp $
...
package std_logic_arith is
    ...
    function "<"(L: UNSIGNED; R: UNSIGNED) return BOOLEAN => "lt";
    ...
    function "<="(L: UNSIGNED; R: UNSIGNED) return BOOLEAN => "le";
    ...
    function ">"(L: UNSIGNED; R: UNSIGNED) return BOOLEAN  => "gt";
    ...
    function ">="(L: UNSIGNED; R: UNSIGNED) return BOOLEAN => "ge";
...
package body std_logic_arith is
    ...
    begin
       if (ARG'length > SIZE) then
                 ...
                 ret := (others => arg(arg'left));
                 ret(arg'length-1 downto 0) := arg;
       end if;
       return(ret);
    end;
